...
namespace DiscGolf_Disc_Lookup_CLI
{
    public class DiscList
    {
        public static List<DiscGolfDisc> Discs = new List<DiscGolfDisc>
        {
            ...
            new DiscGolfDisc("Avenger", "Discraft", "Distance Driver", 10, 5, 0, 3),
            new DiscGolfDisc("Avenger SS", "Discraft", "Distance Driver", 10, 5, -3, 1),
            ...
            new DiscGolfDisc("Zombee", "Discraft", "Fairway Driver", 6, 5, -1, 1),
